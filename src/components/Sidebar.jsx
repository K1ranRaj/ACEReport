...
function Sidebar({ topStories = [] }){
  ...
  return (
    <aside className="w-full">
      <div className={`glass-card p-5 max-md:px-[0.7rem] lg:p-3 xl:6 rounded-2xl space-y-4 slide-in-left ${theme === 'dark' && 'max-lg:!px-1'}`}>
      ...
      <div className={`glass-card p-5 max-md:px-[0.7rem] md:p-6 rounded-2xl space-y-4 slide-in-left mt-6 ${theme === 'dark' && 'max-lg:!px-1'}`}>
        <h4 className="section-title flex items-center gap-2">
